    ...
    >
      ...
      {stage === "intro" && (
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-6 px-8 text-center">
            ...
            {/* label kecil */}
            <div
              className="float-1 text-xs tracking-[0.3em] uppercase"
            ...
            <div className="float-2 flex flex-col items-center gap-1">
              ...
              <div
                className="text-lg tracking-[0.5em] uppercase glow-text"
            ...
            {/* divider */}
            <div
              className="float-2 w-16 h-px"
              style={{ background: "linear-gradient(90deg, transparent, rgba(99,102,241,0.6), transparent)" }}
            />

            {/* subtitle */}
            <div
              className="float-2 text-sm"
      ...
      {stage === "loading" && (
        <div
          ...
          style={{ background: "linear-gradient(135deg, #0f0c29, #302b63, #24243e)", animation: "fadeIn 0.3s ease-out" }}
        >
          <div className="text-center">
            <div className="text-xl font-bold tracking-widest mb-2" style={{ animation: "glowPulse 1.5s ease-in-out infinite" }}>
              FAJREZZZ EXPERIENCE
            </div>
          ...
          {preview && (
            ...
            >
              ...
              <img
                ...
                style={{ maxWidth: "90%", maxHeight: "80vh", borderRadius: "16px", boxShadow: "0 25px 60px rgba(0,0,0,0.8)" }}
              />
          ...
          >
            {[
              ...
              <button
                ...
                style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px", padding: "6px 16px", borderRadius: "16px", color: activeTab === tab ? "white" : "rgba(255,255,255,0.35)", transition: "all 0.15s ease", background: activeTab === tab ? "rgba(255,255,255,0.08)" : "transparent" }}
